...
public class AudioTest : MonoBehaviour
{
	...
	void OnGUI ()
	{
		if (GUI.Button (new Rect (10, 10, 400, 200), "sine_on")) 
		{
			KalimbaPd.SendBangToReceiver("sine_on");
		}
		
		if (GUI.Button (new Rect (10, 10+200+10, 400, 200), "sine_off")) 
		{
			KalimbaPd.SendBangToReceiver("sine_off");
		}

		if (GUI.Button (new Rect (10, 10+200+10+200+10, 400, 200), "oggtest")) 
		{
